...
public class MemberController {
    ...
    public Result register(@RequestBody UserRegisterVo userRegisterVo){
        log.info("用户注册:{}", JSON.toJSONString(userRegisterVo));
     ...
     **/
    @PostMapping("/login")
    public Result<MemberResponseVo> login(@RequestBody UserLoginVo userLoginVo){
        log.info("用户登录:{}", JSON.toJSONString(userLoginVo));
        return memberService.login(userLoginVo);
    }
